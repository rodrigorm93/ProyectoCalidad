...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::open(array('url'=>'noticias/updateNoticia', 'method'=>'POST', 'class'=>'stdform', 'files' => true, 'name'=>'formu', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off'))!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="titulo" name="titulo" type="text" value="{{$noticia->titulo}}" class="form-control" required>
                            </div>
                        </div>

                        <input id="idNoticia" type="hidden" name="idNoticia" value="{{$noticia -> id_noticia}}">
                        
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <textarea class="form-control" id="descripCK" name="descripcion" value="{!!($noticia->descripcion)!!}" rows="7" required></textarea>
                            </div>  
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <FONT SIZE=4 COLOR="green"><strong>Imagen de Portada:</strong></FONT>
                            @foreach ($imagen as $imagen)
                        <input id="idImagen" type="hidden" name="idImagen" value="{{$imagen -> id_foto}}">
					  	  <img  src="{{$imagen -> foto}}" style="width:100%; height: 100%">
					  	@endforeach
                          <FONT SIZE=4 COLOR="green"><strong>Cambiar Imagen:</strong></FONT>

...
@section ('contenido')
    ...
    <div class="row">
        <div class = "col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <fieldset>
                <legend><h3>Editar Alumno: {{ $usuario->id }}-{{ $usuario->digito }}</h3></legend>
            @if(count($errors) > 0)
            ...
            {!!Form::model($usuario, ['method'=>'PATCH', 'route'=>['alumno.update', $usuario->id]]) !!}
            {{Form::token()}}
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" style="width: 300px;" placeholder="Ej: mesoltelcabello@hotmail.com" value="{{$usuario->email}}">
            </div>

            <div class="form-group">
                <label for="ingresoYear">Año ingreso: </label>
                <input type="text" name="ingresoYear" value="{{$alumno->ingreso}}">
            </div>
